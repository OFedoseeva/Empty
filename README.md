...
```
cd existing_repo
git remote add origin https://sauron.dev.amtech.ru/olga.n.fedoseeva/10.git
git branch -M main
...
- [ ] [Настройте интеграцию](https://sauron.dev.amtech.ru/olga.n.fedoseeva/10/-/settings/integrations)
